...
function SocialDropdown(props: {
  ...
  return (
    <div class={`group relative flex items-center h-9 w-9 transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] bg-(--icon-btn-bg) hover:bg-(--icon-btn-hover) rounded-full overflow-hidden hover:overflow-visible [&_svg]:fill-(--icon-btn-fill) [&_svg]:opacity-60 hover:[&_svg]:opacity-100 ${props.hoverClass}`}>
    ...
    <header class="relative w-full flex flex-col items-center justify-end pt-12 pb-8 text-center max-sm:pt-14 max-sm:pb-6">
      <nav class="absolute top-4 right-0 flex items-center gap-4 max-sm:top-3" aria-label="External links">
        ...
        <SocialDropdown 
          ...
          links={[
            { name: 'Mvkweb', url: 'https://x.com/MvkMvk216561' },
      ...
      <div class="relative flex flex-col items-center group cursor-pointer mb-4" aria-hidden="true">
        <div class="w-[84px] h-[84px] rounded-[24px] bg-(--hero-surface) border border-[rgba(255,255,255,0.08)] shadow-[0_12px_32px_rgba(0,0,0,0.35)] flex items-center justify-center relative overflow-hidden transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:scale-105 group-hover:border-[rgba(255,255,255,0.18)] group-hover:shadow-[0_16px_40px_rgba(0,0,0,0.5)]">
